#!/bin/bash
# Build script for che-xcode-mcp MCPB package
...
echo "=== che-xcode-mcp MCPB Build Script ==="
...
ARM64_BINARY="$PROJECT_DIR/.build/arm64-apple-macosx/release/CheXcodeMCP"
X64_BINARY="$PROJECT_DIR/.build/x86_64-apple-macosx/release/CheXcodeMCP"
UNIVERSAL_BINARY="$SERVER_DIR/CheXcodeMCP"
...
if command -v mcpb &> /dev/null; then
    ...
    echo ""
    echo "=== Build Complete ==="
    echo "MCPB package: $MCPB_DIR/che-xcode-mcp.mcpb"
else
